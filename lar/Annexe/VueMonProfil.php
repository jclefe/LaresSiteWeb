        ...
        <form method="post" action="ControleurMonProfil.php"> 
                ...
                <div class="conteneur">
                    ...
                    <div id="genre">
                        ...
                        <input type="radio" name="restrict" id="restrict2" value="1"><label for="restrict2"class="textinput">Non</label>
                    </div>
                    <input class="inputclassiqu" id="e-mail" type="text" id="mail" disabled/>
                    <div id="retour">                     
                    		<button type="submit" name="submit" id="inscrire" class="textinput">Envoyer</button>
                    		<a href="../Mes_donnees/VueValeurCapteur.php" class="textinput">Retour</a>
                    </div>
                </div>          
        </form>                                                
